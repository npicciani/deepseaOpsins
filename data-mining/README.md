# data-mining: opsins from translated transcriptomes

Part of [deepseaOpsins](../README.md). This pipeline pulls opsin sequences out of translated transcriptomes by BLAST + phylogenetic placement (PIA approach).
...
Run from inside this folder -- all paths in the workflow are relative to it:
